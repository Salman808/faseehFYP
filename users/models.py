...
#     academic_score = models.CharField(max_length=255, blank=True)
#     start = models.CharField(max_length=255, blank=True)
#     end = models.CharField(max_length=255, blank=True)
#
#     title = models.CharField(max_length=255, blank=True)
#     company_name = models.CharField(max_length=255, blank=True)
#     Experience_start = models.CharField(max_length=255, blank=True)
#     Experience_end = models.CharField(max_length=255, blank=True)
#
#     Activities_title = models.CharField(max_length=255, blank=True)
